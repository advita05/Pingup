...
const StoryModel = ({ setShowModal, fetchStories }) => {
  ...
  return (
    <div>
      <div className="fixed inset-0 min-h-screen bg-black/80 z-110 backdrop-blur text-white flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <button onClick={()=> toast.promise(handleCreateStory(), { loading: 'saving...', success:<p>Story created!</p> , error: <p>Could not create story.</p> })}
