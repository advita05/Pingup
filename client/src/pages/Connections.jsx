      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {dataArray.map((item, index) => (
            ...
            >
              <b>{Array.isArray(item.value) ? item.value.length : 0}</b>
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === "Connections" && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-slate-80 active:scale-95 transition cursor-pointer flex items-center justify-center gap-1"
                      >
